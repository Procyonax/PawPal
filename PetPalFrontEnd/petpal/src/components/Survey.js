...
//             <br />
//             <select className="size-button" name="size" value={formData.size} onChange={handleChange}>
...
const Survey = ({ handleChange, handleSubmit, formData }) => {
  ...
  const renderQuestion = (question, index) => {
    const { label, name, min, max } = question;
  ...
  return <div className="survey-container">{questions.map(renderQuestion)}</div>;
};
