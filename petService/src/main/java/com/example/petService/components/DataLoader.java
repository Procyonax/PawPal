...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        PawProfile Baxter = new PawProfile("Baxter",LocalDate.of(2017,7,3), cockapoo, "APEX Vets", "5551234", "DMG Grooming", "5556789", "1Baxter.jpg");
        ...
        PawTracker Lassie1 = new PawTracker(Lassie, LocalDate.of(2023,6,2), "Walking", 90);
        pawTrackerRepository.save(Lassie1);
        PawTracker Lassie2 = new PawTracker(Lassie, LocalDate.of(2023,6,2), "Walking", 90);
        pawTrackerRepository.save(Lassie2);
        PawTracker Lassie3 = new PawTracker(Lassie, LocalDate.of(2023,6,2), "Training", 60);
        pawTrackerRepository.save(Lassie3);
        PawTracker Lassie4 = new PawTracker(Lassie, LocalDate.of(2023,6,2), "Teeth brushing", 15);
        pawTrackerRepository.save(Lassie4);
        PawTracker Lassie5 = new PawTracker(Lassie, LocalDate.of(2023,6,2), "Brushing coat", 30);
        pawTrackerRepository.save(Lassie5);
        PawTracker Lassie6 = new PawTracker(Lassie, LocalDate.of(2023,6,3), "Walking", 90);
        pawTrackerRepository.save(Lassie6);
        PawTracker Lassie7 = new PawTracker(Lassie, LocalDate.of(2023,6,3), "Walking", 90);
        pawTrackerRepository.save(Lassie7);
        PawTracker Lassie8 = new PawTracker(Lassie, LocalDate.of(2023,6,3), "Training", 60);
        pawTrackerRepository.save(Lassie8);
        PawTracker Lassie9 = new PawTracker(Lassie, LocalDate.of(2023,6,3), "Teeth brushing", 15);
        pawTrackerRepository.save(Lassie9);
        PawTracker Lassie10 = new PawTracker(Lassie, LocalDate.of(2023,6,3), "Brushing coat", 30);
        pawTrackerRepository.save(Lassie10);
        PawTracker Marley1 = new PawTracker(Marley, LocalDate.of(2023,6,2), "Walking", 90);
        pawTrackerRepository.save(Marley1);
        PawTracker Marley2 = new PawTracker(Marley, LocalDate.of(2023,6,2), "Walking", 90);
        pawTrackerRepository.save(Marley2);
        PawTracker Marley3 = new PawTracker(Marley, LocalDate.of(2023,6,2), "Training", 60);
        pawTrackerRepository.save(Marley3);
        PawTracker Marley4 = new PawTracker(Marley, LocalDate.of(2023,6,2), "Teeth brushing", 15);
        pawTrackerRepository.save(Marley4);
        PawTracker Marley5 = new PawTracker(Marley, LocalDate.of(2023,6,2), "Brushing coat", 30);
        pawTrackerRepository.save(Marley5);
        PawTracker Marley6 = new PawTracker(Marley, LocalDate.of(2023,6,3), "Walking", 90);
        pawTrackerRepository.save(Marley6);
        PawTracker Marley7 = new PawTracker(Marley, LocalDate.of(2023,6,3), "Walking", 90);
        pawTrackerRepository.save(Marley7);
        PawTracker Marley8 = new PawTracker(Marley, LocalDate.of(2023,6,3), "Training", 60);
        pawTrackerRepository.save(Marley8);
        PawTracker Marley9 = new PawTracker(Marley, LocalDate.of(2023,6,3), "Teeth brushing", 15);
        pawTrackerRepository.save(Marley9);
        PawTracker Marley10 = new PawTracker(Marley, LocalDate.of(2023,6,3), "Brushing coat", 30);
        pawTrackerRepository.save(Marley10);
        PawTracker Laika1 = new PawTracker(Laika, LocalDate.of(2023,6,2), "Walking", 90);
        pawTrackerRepository.save(Laika1);
        PawTracker Laika2 = new PawTracker(Laika, LocalDate.of(2023,6,2), "Walking", 90);
        pawTrackerRepository.save(Laika2);
        PawTracker Laika3 = new PawTracker(Laika, LocalDate.of(2023,6,2), "Training", 60);
        pawTrackerRepository.save(Laika3);
        PawTracker Laika4 = new PawTracker(Laika, LocalDate.of(2023,6,2), "Teeth brushing", 15);
        pawTrackerRepository.save(Laika4);
        PawTracker Laika5 = new PawTracker(Laika, LocalDate.of(2023,6,2), "Brushing coat", 30);
        pawTrackerRepository.save(Laika5);
        PawTracker Laika6 = new PawTracker(Laika, LocalDate.of(2023,6,3), "Walking", 90);
        pawTrackerRepository.save(Laika6);
        PawTracker Laika7 = new PawTracker(Laika, LocalDate.of(2023,6,3), "Walking", 90);
        pawTrackerRepository.save(Laika7);
        PawTracker Laika8 = new PawTracker(Laika, LocalDate.of(2023,6,3), "Training", 60);
        pawTrackerRepository.save(Laika8);
        PawTracker Laika9 = new PawTracker(Laika, LocalDate.of(2023,6,3), "Teeth brushing", 15);
        pawTrackerRepository.save(Laika9);
        PawTracker Laika10 = new PawTracker(Laika, LocalDate.of(2023,6,3), "Brushing coat", 30);
        pawTrackerRepository.save(Laika10);
